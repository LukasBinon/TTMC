...
import models.Card;
import models.CardInformatic;
import models.Question;

public class InformaticCardFactory extends CardFactory {

	@Override
    protected List<Question> selectQuestions(List<Question> allQuestions) {
        List<Question> filtered = allQuestions.stream()
                .filter(q -> q.getThemeName().equalsIgnoreCase("Informatics"))
	...
	public Card createCard(List<Question> allQuestions) {
		return new CardInformatic(selectQuestions(allQuestions));
	}
